    ...
    <main class="main-dtll">
        <section class="sct-banner-dtll pos-rel">
            ...
            <div class="container content-title-banner">
                <h2 class="title-banner font-nexaheavy text-uppercase">por su bebé</h2>
            </div>
            <ol class="breadcrumb bread-products container">
                <li class="item-bradcrumb"><a href="#" class="link-bradcrumb">Productos</a></li>
                <li class="item-bradcrumb"><a href="linea-bebe.php" class="link-bradcrumb">linea-bebe</a></li>
                <li class="item-bradcrumb"><a href="extractores.php" class="link-bradcrumb bienestar active">extractores</a></li class="item-bradcrumb">
            </ol>
        </section>
        <!-- NAV TABS -->
        <section class="container">
            <div class="row">
                <ul class="nav-tabs-int slid-linea-bb">
                    <li class="item-nav-tabs <?= in_array('extractores.php', $uriSegments ) ? 'active' : ''; ?>">
                        <a href="extractores.php" class="link-nav-tabs">extractor 1</a>
                    </li>
                    <li class="item-nav-tabs <?= in_array('sleepline.php', $uriSegments ) ? 'active' : ''; ?>">
                        <a href="#" class="link-nav-tabs">extractor 2</a>
                    </li>
                    <li class="item-nav-tabs <?= in_array('sensores-de-sueno.php', $uriSegments ) ? 'active' : ''; ?>">
                        <a href="#" class="link-nav-tabs">extractor 3</a>
                    </li>
                    <li class="item-nav-tabs <?= in_array('luz-para-despertar.php', $uriSegments ) ? 'active' : ''; ?>">
                        <a href="#" class="link-nav-tabs">extractor 4</a>
                    </li>
                </ul>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-3">
                        <div class="info-subproduct animatedParent animateOnce" data-sequence='500'>
                            <h2 class="ttl-info-subproducts color-linea-bb font-nexaheavy text-uppercase animated fadeInLeftShort" data-id="1">extractores
                            </h2>
                    ...
                    <div class="col-xs-12 col-md-9">
                        <div class="row animatedParent animateOnce" data-sequence='500'>
                            <div class="col-xs-6 col-md-4 px-0 animated fadeInLeftShort" data-id="1">
                                <div class="wrapper-cards-products dtll card-prd-linea-bb">
                                    ...
                                    <div class="content-title-card">
                                        ...
                                        <div class="btn-vp border-linea-bb">
                                            <a href="detalle-de-producto.php" class="a-btn font-nexaheavy color-linea-bb">ver producto</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
