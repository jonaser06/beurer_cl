...
//$project = ''; //produccion
$project = '/clientes/negocios/test/'; //test
...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $project,
	...
	*/
	...
	'access_keys' => array(md5(md5('LuisZagaceta@' . date('Y-m-d')))),
