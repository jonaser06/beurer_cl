function Helpers() {
    ...
    $('#modalCreateEdit').on('hidden.bs.modal', function (e) {
        $(e.target).find('div.modal-dialog').remove();

        return false;
    });
    
    $('#modalCreateEdit2').on('hidden.bs.modal', function (e) {
        $(e.target).find('div.modal-dialog2').remove();
...
//            "rowReorder": true,
    ...
    this.UpdateInfo = function (dataUser){
    ...
    this.loadResponsejm = function (response) {
        var modal = $('#modalCreateEdit2');
        modal.html(response);
//        modal.modal('toggle');
    };
    ...
    this.floor10 = function (value, exp) {
        return decimalAdjust('floor', value, exp);
    };

    this.ceil10 = function (value, exp) {
    ...
    this.tinyInit = function (aKey) {
        //var project = '/clientes/beurer/test/';//desarrollo
