    ...
    <main class="main-products">
        ...
        <section class="sct-banner container-fluid px-0 d-flex justify-content-center">
            ...
            <div class="content-img-banner">
                <img src="<?php echo base_url(); ?>assets/images/banner/bajas/ind-alimentaria.jpg" alt="">
            </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 titles-big-products textR">
                                ...
                                <?php
                                    $titulo_2 = "";
                                    if ($lang == 'es/') {
                                        $titulo_1 = explode(' ', $categoria['categoria']);
                                    }else{
                                        $titulo_1 = explode(' ', $categoria['categoria_en']);
                                    }
                                ?>
                    ...
                    <div class="col-12 d-lg-none content-accordion-mobile">
                        <ul class="accordion content-subProducts">
                            <!-- Cetogoria movil -->
                            <?php foreach ($categoria['producto_data'] as $row) { ?>
