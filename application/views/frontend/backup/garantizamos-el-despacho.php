    ...
    <main class="">
        ...
        <section class="sct-banner container-fluid px-0 d-flex justify-content-center">
            ...
            <div class="content-img-banner">
                <img src="<?php echo base_url().$relacion['despacho_bg']; ?>" alt="">
            </div>
            <div class="content-text-banner container d-flex flex-column justify-content-end wow fadeInLeft">
                <h1 class="title-big-banner titles-big textUppercase"><?= ($lang == 'es/')? $contenido['h1_imagen']:$contenido['h1_imagen_en']; ?></h1>
                <span class="subtitle-banner font-titles-md textUppercase"><?= ($lang == 'es/')? $contenido['span_imagen']:$contenido['span_imagen_en']; ?></span>
            </div>
        </section>
        <?php
                            ...
                            <div class="col-12 col-lg-11">
                                <div class="row justify-content-center">
                                    <div class="col-12 content-description px-0 d-flex flex-column wow fadeInLeft">
                                        <i class="icon-descr icon-despacho"></i>
                                        <h1 class="titles-big color-secondary"><?= ($lang == 'es/')? $contenido['titulo_pagina_1']:$contenido['titulo_pagina_1_en']; ?></h1>
