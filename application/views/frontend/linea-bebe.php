    ...
    <main class="main-products">
        <section class="sct-banner-products pos-rel" id="section0">
            ...
            <div class="container content-title-banner">
                <h3 class="title-peq-bproducts font-bold text-uppercase"><?= $contenido['t_linea_bebe_img'] ?></h3>
                <h2 class="title-b-products font-bold text-uppercase"><?= $contenido['st_linea_bebe_img'] ?></h2>
            </div>
        </section>
            ...
            <div class="row">
                <div class="info-general-products col-xs-12 col-md-5 col-lg-4 animatedParent animateOnce" data-sequence='500'>
                    ...
                    <ol class="breadcrumb bread-products animated fadeInLeftShort" data-id="1">
                        ...
                        <li class="item-bradcrumb"><a href="<?= base_url($pagina['url']); ?>" class="link-bradcrumb color-linea-bb active">línea bebé</a></li>
                    </ol>
                    <div class="wrapper-title-info t-linea-bb animated fadeInLeftShort" data-id="2">
                        <i class="icon-t-info icon-linea-bb"></i>
                        <h2 class="title-info"><?= $contenido['t_linea_bebe'] ?></h2>
                    </div>
                    <p class="p-regular animated fadeInLeftShort" data-id="3"><?= $contenido['c_linea_bebe'] ?></p>
                </div>
                        ...
                        <div class="animatedParent animateOnce" data-sequence='900'>
                            ...
                            <a href="<?= base_url($pagina['url']).'/'.$row['url'] ?>">
                                <div class="wrapper-card-info col-xs-12 col-sm-6 col-lg-4 px-0 animated fadeInLeftShort" data-id="1"
                                    ...
                                    <div class="hover-card-product bg-linea-bb"></div>
                                </div>
                            </a>    
                            <?php } ?>
