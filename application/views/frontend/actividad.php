    ...
    <main class="main-products">
        <section class="sct-banner-products pos-rel" id="section0">
            ...
            <div class="container content-title-banner">
                <h3 class="title-peq-bproducts font-bold text-uppercase"><?= $contenido['t_actividad_img'] ?></h3>
                <h2 class="title-b-products font-bold text-uppercase"><?= $contenido['st_actividad_img'] ?></h2>
            </div>
        </section>
            ...
            <div class="row">
                <div class="info-general-products col-xs-12 col-md-5 col-lg-4 animatedParent animateOnce" data-sequence='500'>
                    ...
                    <ol class="breadcrumb bread-products animated fadeInLeftShort" data-id="1">
                        ...
                        <li class="item-bradcrumb"><a href="<?= base_url($pagina['url']); ?>" class="link-bradcrumb color-actividad active">actividad</a></li class="item-bradcrumb">
                    </ol>
                    <div class="wrapper-title-info t-actividad animated fadeInLeftShort" data-id="2">
                        <i class="icon-t-info icon-actividad"></i>
                        <h2 class="title-info"><?= $contenido['t_actividad'] ?></h2>
                    </div>
                    <p class="p-regular animated fadeInLeftShort" data-id="3"><?= $contenido['c_actividad'] ?></p>
                </div>
