    ...
    <main class="main-products">
        <section class="sct-banner-products pos-rel" id="section0">
            ...
            <div class="container content-title-banner">
                <h3 class="title-peq-bproducts font-bold text-uppercase"><?= $contenido['t_salud_img'] ?></h3>
                <h2 class="title-b-products font-bold text-uppercase"><?= $contenido['st_salud_img'] ?></h2>
            </div>
        </section>
                ...
                <div class="info-general-products col-xs-12 col-md-5 col-lg-4 animatedParent animateOnce" data-sequence='500'>
                    ...
                    <ol class="breadcrumb bread-products animated fadeInLeftShort" data-id="1">
                        ...
                        <li class="item-bradcrumb">
                            <a href="<?= base_url($pagina['url']); ?>" class="link-bradcrumb color-salud active">Salud</a>
                        </li class="item-bradcrumb">
                    </ol>
                    <div class="wrapper-title-info t-salud animated fadeInLeftShort" data-id="2">
                        <i class="icon-t-info icon-salud"></i>
                        <h2 class="title-info"><?= $contenido['t_salud'] ?></h2>
                    </div>
                    <p class="p-regular animated fadeInLeftShort" data-id="3"><?= $contenido['c_salud'] ?></p>
                </div>
