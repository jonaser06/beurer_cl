...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                ...
                                <a href="javascript: Exeperu.addUsuario()" class="btn btn-xs btn-info btn-flat"><i class="glyphicon glyphicon-plus"></i> Agregar</a><br><br>
                                <?php }?>
        ...
        <script src="<?= getFilex('mgr/exeperu/js/usuarios.js') ?>"></script>

        <script>
            $(document).ready(function () {
                Exeperu.init({
                    'url': 'manager/usuarios/read',
                });
            });
        </script>
    </body>
