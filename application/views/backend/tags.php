...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                ...
                                <a href="javascript: Exeperu.addTag()" class="btn btn-xs btn-info btn-flat"><i class="glyphicon glyphicon-plus"></i> Agregar</a><br><br>
                                <?php }?>
                                <table id="table_tags" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>Nombre</th>
                                            <th>Orden</th>
        ...
        <script src="<?= getFilex('mgr/exeperu/js/tags.js') ?>"></script>

        <script>
            $(document).ready(function () {
                Exeperu.init({
                    'url': 'manager/tags/read'
                });
            });
        </script>
    </body>
