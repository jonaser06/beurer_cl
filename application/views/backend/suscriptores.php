...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                <a href="manager/suscriptores/exportarsus" class="btn btn-sm btn-success btn-flat" target="_blank"><i class="glyphicon glyphicon-download-alt"></i> Exportar</a>
                                <br><br>
        ...
        <script src="<?= getFilex('mgr/exeperu/js/suscriptores.js') ?>"></script>

        <script>
            $(document).ready(function () {
                Exeperu.init({
                    'url': 'manager/suscriptores/read'
                });
            });
        </script>
    </body>
