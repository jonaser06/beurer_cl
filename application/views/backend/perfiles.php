...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                ...
                                <a href="javascript: Exeperu.addPerfil()" class="btn btn-xs btn-info btn-flat"><i class="glyphicon glyphicon-plus"></i> Agregar</a><br><br>
                                <?php }?>
                                <table id="table_perfiles" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>Perfil</th>
                                            <th>Estado</th>
        ...
        <script src="<?= getFilex('mgr/exeperu/js/perfiles.js') ?>"></script>

        <script>
            $(document).ready(function () {
                Exeperu.init({
                    'url': 'manager/perfiles/read'
                });
            });
        </script>
    </body>
