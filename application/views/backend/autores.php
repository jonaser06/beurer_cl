...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="nav-tabs-custom">
                                ...
                                <a href="javascript: Exeperu.addAutor()" class="btn btn-xs btn-info btn-flat"><i class="glyphicon glyphicon-plus"></i> Agregar</a><br><br>
                                <?php }?>
                                <table id="table_autores" class="table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>Nombres</th>
                                            <th>Apellidos</th>
        ...
        <script src="<?= getFilex('mgr/exeperu/js/autores.js') ?>"></script>

        <script>
            $(document).ready(function () {
                Exeperu.init({
                    'url': 'manager/autores/read'
                });
            });
        </script>
    </body>
