...
<main class="main-detail-products">
    ...
    <div class="pasos"  style="padding-top:3em;">
        <div class="rectanguloProceso" >
            <div class="lineaProceso" ></div>
            
                <div class="circuloProceso">1</div> 
                <div class="circuloProcesoActivo">2</div>
                <div class="circuloProceso">3</div>	
                <div class="circuloProceso">4</div>		
                        
        </div>	
        <div class="rectangulo" >
                <div class="etiquetaProceso">Carrito de compras</div>	
                <div class="etiquetaProceso">Datos y Facturación</div>					
                <div class="etiquetaProceso">Envío y Pago</div>	
                <div class="etiquetaProceso">Resumen de Pedido</div>		
        </div>			
</div>
...
<div class="titulo" >Registrarse para completar la compra</div>
    ...
    <div>
        <div class="checkbox" style="display:inline-block;">
            ...
            <div style="display:inline-block; font-size:1.3em; font-weight:bold;">  Marque esta casilla, si el destinatario del pedido será una tercera persona</div>
        </div>
                    ...
                    <div class="divTable" style=" width:100%;display:inline-block;" >
                        <div class="divTableBody" style="display:block;">
                            ...
                            <div class="divTableRow">
                                ...
                                <div class="divTableCell"><div class="tituloTabla1">Departamento<div class="d_ob">(*)</div></div>
                            ...
                            <div class="divTableRow">
                                <div class="divTableCell"><div class="tituloTabla1">Provincia<div class="d_ob">(*)</div></div>
                                ...
                                <div class="divTableCell"><div class="tituloTabla1">Distrito<div class="d_ob">(*)</div></div>
                                    <select id="s_dist" >
                            ...
                            <div class="divTableRow">
                                <div class="divTableCell"><div class="tituloTabla1">Dirección de entrega<div class="d_ob">(*)</div></div>
                                    <input type="text" size="20" maxlength="45" name="campo1" id="campo1" value="" >		
                                </div>
                                <div class="divTableCell"><div class="tituloTabla1">Referencia</div>
                                    <input type="text" size="20" maxlength="45" name="campo1" id="campo1" value="" >		
                                </div>
                            </div>
...
<div class="row cont_datos" id="d_formularios2" align="center" style="display:none;width:46em;">
    ...
    <div style="text-align:center !important;" >
        <div class="checkbox" style="display:inline-block; " id="d_fact">
            ...
            <div style="display:inline-block; font-size:1.3em; font-weight:bold;"> Deseo una factura</div>
        </div>
    </div>
...
<span ><a class="btn btn-primary1 disabled" id="btn_sgt" href="envio-pago.php" >SIGUIENTE</a></span>	
</div>
